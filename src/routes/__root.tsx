          ...
          <div className="sticky top-0 z-[60] md:relative md:z-auto backdrop-blur-md bg-white/50">
           <StoreAlertBanner />
            {isSupabaseMissing && isAdmin && (
              <div className="bg-red-700 text-white px-4 py-4 flex items-center justify-between shadow-2xl animate-shake-critical ring-4 ring-black/20 ring-inset border-b-2 border-white/10">
